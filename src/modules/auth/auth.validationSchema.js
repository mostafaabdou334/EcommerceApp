...
export const signUpSchema = {
    ...
    body: joi.object({
        ...
        confirmedPassword: joi.string().valid(joi.ref('password')).required().messages({ 'any.required': 'confirmedPassword is required', 'any.only': 'confirmedPassword must match password' }),
...
export const updateProfileSchema = {
    ...
    body: joi.object({
        ...
        age: joi.number(),
        phone: joi.string().pattern(/^01[0125][0-9]{8}$/).messages({ 'any.required': 'phone is required', 'string.pattern.base': 'phone must be in phone form' }),
